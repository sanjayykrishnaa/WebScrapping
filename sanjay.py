...
searchinput=input("Enter the item you want : ")
...
# df_clean.to_csv("richin.csv", index = False)
# df_clean.to_excel("richin.xlsx", index = False)
# df_clean.to_html("richin.html", index = False)
# df_clean.to_json("richin.json", index = False) 
